---
layout: post
title:  "Extract Generic Functionality"
date:   2022-10-26 16:00:00 +0200
---
* Don't mix generic functionality
* The missing refactoring tutorial
* The refactoring tutorial you always missed

## Genesis
You were assigned a task to implement a new functionality in the legacy stock trading platform.
...
You are an experienced programmer, so the task was straightforward and took less time than expected.
The main meat of the finished code looks as follow:
```java
...
```
You filled in the pull request. You are ready to click the submit button, but some noise outside the window distracts you... it is
just a horde of motorcyclists. While backing to the pull request, you notice the dusty "Clean Code" which serves as a monitor stand.

Suddenly you remind yourself of all Uncle Bob's arguments about software craftsmanship, professionalism and the alike nonsenses.
